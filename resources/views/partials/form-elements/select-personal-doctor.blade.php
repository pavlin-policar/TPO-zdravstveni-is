...
<div class="form-group{{ $errors->has('personal_doctor_id') ? ' has-error' : '' }}">
    {!! Form::label('personal_doctor_id', 'Osebni zdravnik', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-10">
        {!! Form::select('personal_doctor_id', [-1 => 'Izberite osebnega zdravnika...'] + $doctors, $selectedDoctor, ['class' => 'form-control', 'required']) !!}
