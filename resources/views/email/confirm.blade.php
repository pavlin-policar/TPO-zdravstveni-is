...
<div>
    ...
    <p>Da bi zaključili registracijo, morate potrditi elektronski naslov. To lahko storite tako, da sledite povezavi {!! link_to_route('register.confirm-email', 'TUKAJ', [$confirmationCode]) !!} ali pa ročno vnesite aktivacijsko kodo:
        <br>
