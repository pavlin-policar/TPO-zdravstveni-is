...
<div class="form-group{{ $errors->has('doctor_number') ? ' has-error' : '' }}">
    {!! Form::label('doctor_number', 'Šifra doktorja', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-10">
...
<div class="form-group{{ $errors->has('max_patients') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-10">
        ...
        <span class="help-block">Vnesite maksimalno število pacientov, za katere lahko naenkrat skrbite.</span>
